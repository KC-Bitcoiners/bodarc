<script lang="ts">
	...
	import { user, isLoading } from '$lib/stores/nostr';
...
<header class="bg-white text-black sticky top-0 z-50 border-b border-gray-200">
	<nav class="container mx-auto px-6 py-4">
		<div class="flex items-center justify-between">
			...
			>
				<img src={logo} alt={config.site.organization.name} class="h-8 w-auto" />
			...
			<div class="hidden md:flex items-center space-x-8">
				...
				<a
					href="/donate"
					class="font-semibold transition-colors {currentPath === '/donate' ? 'bitcoin-orange' : 'hover:text-bitcoin-orange'}"
				>
					Donate
				</a>
				<a
